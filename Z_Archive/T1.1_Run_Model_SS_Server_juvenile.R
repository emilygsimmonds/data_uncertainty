...
output_all <- map2(.x = model_inputs,
                   .y = y, ~{
                     ...
                     save(model_result, 
                          ...
                          file = paste0("/cluster/work/emilygs/result3/juvenile_missing_SS_result", 
                                        .y, ".RData"))
                   }, .progress = TRUE)

#
#load("./Data files/juvenile_missing_simulationmax.RData")
#
#model_inputs <- map(
#  .x = juvenile_missing_reproduction, 
#  .f = make_input_data, 
...
#plan(multisession, workers = 4)
#
#output_all <- map2(.x = model_inputs[53:75],
#                   .y = y[53:75], ~{
#                     model_result <- nimbleMCMC(code = Model_SS_hmm, 
#                                                data = .x$data_input,
#                                                constants = .x$constants,
...
#                     # save out result at each pass
#                     save(model_result, 
#                          file = paste0("/cluster/work/emilygs/result3/juvenile_missing_max_result", 
#                                        .y, ".RData"))
#                   }, .progress = TRUE)
#
#load("./Data files/juvenile_missing_simulationmax0.RData")
#
#model_inputs <- map(
#  .x = juvenile_missing_reproduction, 
#  .f = make_input_data, 
...
#                     # save out result at each pass
#                     save(model_result, 
#                          file = paste0("/cluster/work/emilygs/result3/juvenile_missing_max0_result", 
#                                        .y, ".RData"))
#                   }, .progress = TRUE)
#
#load("./Data files/juvenile_missing_simulationmin.RData")
#
#model_inputs <- map(
#  .x = juvenile_missing_reproduction, 
#  .f = make_input_data, 
...
#                     # save out result at each pass
#                     save(model_result, 
#                          file = paste0("/cluster/work/emilygs/result3/juvenile_missing_min_result", 
#                                        .y, ".RData"))
#                   }, .progress = TRUE)#