...
#load("./Data files/random_missing_simulation.RData")
...
#  save(model_result, 
#       file = paste0("/cluster/work/emilygs/result4/random_missing_SS_result",
#                     .y, ".RData"))
#}, .progress = TRUE)
#
load("./Data files/random_missing_simulationmax.RData")
...
output_all <- map2(.x = model_inputs[1:25],
                   .y = y[1:25], ~{
                     model_result <- nimbleMCMC(code = Model_SS_hmm, 
                                                data = .x$data_input,
                                                constants = .x$constants,
                     ...
                     # save out result at each pass
                     save(model_result, 
                          file = paste0("/cluster/work/emilygs/result4/random_missing_max_result",
                                        .y, ".RData"))
                   }, .progress = TRUE)

#load("./Data files/random_missing_simulationmax0.RData")
#
#model_inputs <- map(
#  .x = random_missing_reproduction,
#  .f = make_input_data, 
...
#                     # save out result at each pass
#                     save(model_result, 
#                          file = paste0("/cluster/work/emilygs/result4/random_missing_max0_result",
#                                        .y, ".RData"))
#                   }, .progress = TRUE)
#
#load("./Data files/random_missing_simulationmin.RData")
#
#model_inputs <- map(
#  .x = random_missing_reproduction,
#  .f = make_input_data, 
...
#                     # save out result at each pass
#                     save(model_result, 
#                          file = paste0("/cluster/work/emilygs/result4/random_missing_min_result",
#                                        .y, ".RData"))
#                   }, .progress = TRUE)
#