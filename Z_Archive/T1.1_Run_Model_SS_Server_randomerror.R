...
#       file = paste0("/cluster/work/emilygs/result5/random_error_SS_result", 
#                     .y, ".RData"))
#}, .progress = TRUE)
...
output_all <- map2(.x = model_inputs[78:100],
                   .y = y[78:100], ~{
                     ...
                     # save out result at each pass
                     save(model_result, 
                          file = paste0("/cluster/work/emilygs/result5/random_error_max_result", 
                                        .y, ".RData"))
                   }, .progress = TRUE)
...
#                     # save out result at each pass
#                     save(model_result, 
#                          file = paste0("/cluster/work/emilygs/result5/random_error_max0_result", 
#                                        .y, ".RData"))
#                   }, .progress = TRUE)
#
...
#                     # save out result at each pass
#                     save(model_result, 
#                          file = paste0("/cluster/work/emilygs/result5/random_error_min_result", 
#                                        .y, ".RData"))
#                   }, .progress = TRUE)#